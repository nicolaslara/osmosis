...
import (
	...
	"github.com/osmosis-labs/osmosis/v10/x/alias/client/cli"
...
// Name returns the x/alias module's name.
...
// DefaultGenesis returns the x/alias module's default genesis state.
func (AppModuleBasic) DefaultGenesis(cdc codec.JSONCodec) json.RawMessage {
	return cdc.MustMarshalJSON(types.DefaultGenesis())
}

// ValidateGenesis performs genesis state validation for the x/alias module.
...
// GetTxCmd returns the x/alias module's root tx command.
func (a AppModuleBasic) GetTxCmd() *cobra.Command {
	return cli.GetTxCmd()
}

// GetQueryCmd returns the x/alias module's root query command.
...
//// InitGenesis performs the x/alias module's genesis initialization. It
...
// EndBlock executes all ABCI EndBlock logic respective to the alias module. It
// returns no validator updates.
